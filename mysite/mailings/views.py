...
from .services import add_email_to_common_list, add_email_to_case_list
...
def add_to_common_list_views(request):
    ...
    add_email_to_common_list(email=email)
    return JsonResponse({"success": True})

def add_to_case_list(request):
    ...
    add_email_to_case_list(email=email, case_id=case_id)    
    return JsonResponse({"success": True})